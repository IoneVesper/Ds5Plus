...
private let englishTranslations: [String: String] = [
    ...
    "选择捕获显示器": "Select Capture Display",
    "请先在 macOS 蓝牙设置中连接 DualSense。": "Please connect DualSense in macOS Bluetooth settings first.",
    "捕获显示器": "Capture Display",
    "当前没有可用的系统音频捕获源。": "No system audio capture sources are currently available.",
    "当前捕获显示器已不可用，请重新选择。": "The selected capture display is no longer available. Please choose another one.",
    "手柄电量": "Battery",
    "灯条偏色": "Lightbar Tint",
    "灯条颜色": "Lightbar Color",
